...
<section class="certificates-section">
    ...
    <ul class="certificates-list">
        ...
        <li>
    <a href="https://ahrarbinaslam.github.io/Data Science Methodology.pdf" class="certificate-title" download>
        Data Science Methodology Certification
    </a>
    <p class="certificate-description">
        Completed the Data Science Methodology certification, gaining a comprehensive understanding of the structured approach to solving data science problems.
    </p>
</li>
        <li>
    <a href="https://ahrarbinaslam.github.io/Data Visualization with Python.pdf" class="certificate-title" download>
        Data Visualization with Python Certification
    </a>
    <p class="certificate-description">
        Earned the Data Visualization with Python certification, mastering the techniques of creating insightful and effective visualizations using libraries such as Matplotlib and Seaborn.
    </p>
</li><li>
    <a href="https://ahrarbinaslam.github.io/Tools for Data Science.pdf" class="certificate-title" download>
        Tools for Data Science Certification
    </a>
    <p class="certificate-description">
        Completed the Tools for Data Science certification, where I gained knowledge about essential data science tools, including Jupyter Notebooks, Google Colab, Git to streamline data science workflows.
    </p>
</li>
    </ul>
</section>
